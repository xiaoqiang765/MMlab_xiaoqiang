...
data_mode = 'topdown'
data_root = '/home/xiaoqiang/mlearning/mmlab2/mmpose/Earwork/dataset'
dataset_info = dict(
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            prefix='backbone.',
            checkpoint=
            '/home/xiaoqiang/mlearning/checkpoint/Earwork/cspnext-s_imagenet_600e.pth'
        )),
    head=dict(
        type='RTMCCHead',
        in_channels=512,
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file=
        '/home/xiaoqiang/mlearning/mmlab2/mmpose/Earwork/dataset/val_coco.json'
    ),
